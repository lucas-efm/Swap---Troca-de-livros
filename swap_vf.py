                    ...
                    while escolha_enviar != '-1':
                        for user in leitores[usuario]['chats']:
                            ...
                            if leitores[usuario]['chats'][user][0] != 0:
                                nao_visualizadas.append(
                                    f'{blue}{count_chat} - {end}{bold}{user}{end} - {red}{leitores[usuario]["chats"][user][0]}{end} {gray}Mensagen(s) nao lida(s){end}')
                            else:
                                visualizadas.append(f'{blue}{count_chat} - {end}{bold}{user}{end}')
                        ...
                        escolha_chat = int(input(f'{gray}Selecione uma conversa para abrir: {end}')) - 1

                        user = conversas[escolha_chat].split(' - ')
                        user = user[1][8:-4]
